...
?>
    ...
    <div class="w-full max-w-7xl mx-auto z-10">
        <div class="flex flex-col lg:flex-row gap-6">
            ...
            <div id="right-panel" class="lg:w-2/3 w-full flex flex-col gap-6">
                ...
                <div id="stack-panel" class="bg-white p-6 rounded-xl shadow-lg">
                    <h2 class="text-2xl font-semibold mb-4 text-center border-b pb-2"><?php echo getTranslation('stack-memory', $currentLang); ?></h2>
                    <div id="stack-grid" class="grid grid-cols-2 md:grid-cols-4 gap-2 text-sm">
                        <!-- Stack cells will be generated here by JavaScript -->
                    </div>
                </div>
    ...
    <script src="lecture2a.js"></script>
